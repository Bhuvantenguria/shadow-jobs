...
const supabaseClient = createClient(
  "https://tmdaqkazyhtqmeotbmaj.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRtZGFxa2F6eWh0cW1lb3RibWFqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTkzMTEzNTAsImV4cCI6MjAzNDg4NzM1MH0.vmvypa4jV951nv955n5yHPy7YUy1yhzLJQf7HoX6m04"
);
          ...
          <div className="container m-auto p-0 flex flex-col gap-5 text-gray-700">
            {allFeedPosts && allFeedPosts.length > 0 ? (
              allFeedPosts.map((feedPostItem) => (
                ...
                >
                  {console.log(feedPostItem?.image)}
